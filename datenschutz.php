...
<div class="container">
	<div class="row">
		...
		<div class="col-xl-12">
			<div class="section-headline border-top margin-top-5 padding-top-45 margin-bottom-15"></div>

			<h1>Datenschutz­erklärung</h1><br>
			...
			<h3>Hinweis zur verantwortlichen Stelle</h3> <p>Die verantwortliche Stelle für die Datenverarbeitung auf dieser Website ist:</p> <p>Sven-Michael Rabe<br />
			Engelsgrube 53<br />
			23552 Lübeck<br />
			Deutschland</p>

			<p>Telefon: 01718123321<br />
			E-Mail: jobs@hl-live.de</p>

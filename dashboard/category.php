...
if (isset($_REQUEST['duplicate'])) {
    $info = duplicate_cat($conn);
}
$show = ad_show_category($conn);
?>
<!doctype html>
<html lang="en">
    ...
    <div class="container-fluid">
        <div class="row">
            <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
                <div class="position-sticky pt-3">
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="category.php">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <h2 class="my-3">Category Added</h2>
                <?php echo $info; ?>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-header">
                ...
                <form action="category.php" method="get">                
                    <input type="hidden" name="dlt_id" value="0" id="cat_id">

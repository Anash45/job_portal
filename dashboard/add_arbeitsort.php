...
$info = $show = '';
if (isset($_REQUEST['add_arbeitsort'])) {
    $info = add_arbeitsort($conn);
}
?>
<!doctype html>
<html lang="en">
    ...
    <div class="container-fluid">
        <div class="row">
            <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
                <div class="position-sticky pt-3">
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="add_arbeitsort.php">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div class="row mx-0">
                    <div class="form-box">
                        <h2 class="my-3">Add New Arbeitsort</h2>
                        <?php echo $info; ?>
                            <form class="row g-3 needs-validation job-form" novalidate method="post" enctype="multipart/form-data">
                                <div class="col-md-12">
                                    ...
                                    <input type="text" class="form-control" name="arbeitsort"  id="input5">
                                </div>
                           
                            <div class="col-12">
                                <button type="submit" class="btn btn-primary" name="add_arbeitsort">Submit</button>
                            </div>
                        </form>
                    </div>
                </div>

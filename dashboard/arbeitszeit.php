...
if (isset($_REQUEST['dlt_id'])) {
    $info = dlt_arbeit($conn);
}
if (isset($_REQUEST['duplicate'])) {
    $info = duplicate_arbeit($conn);
}
$show = ad_show_arbeit($conn);
?>
<!doctype html>
<html lang="en">
            ...
            <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
                <div class="position-sticky pt-3">
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="arbeitszeit.php">
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            ...
            <div class="modal-header">
                ...
                <form action="arbeitszeit.php" method="get">                
                    <input type="hidden" name="dlt_id" value="0" id="arb_id">

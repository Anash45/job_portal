...
$e_day = date('d', strtotime($end_date));
$e_year = date('Y', strtotime($end_date));

$expire = $e_year . '-' . $e_month . '-' . $e_day;
                ...
                <div class="row mx-0">
                    <div class="form-box">
                        ...
                        <form class="row g-3 needs-validation job-form" novalidate method="post" enctype="multipart/form-data">
                            ...
                            <div class="col-md-6">
                                <label for="input91" class="form-label">Firma</label>
                                <select name="c_id" id="input91" class="form-control">
                                    <option value="0" selected disabled>Firma wählen</option>
                                    <?php echo $show1; ?>
                                </select>
                            </div>
                            ...
                            <div class="col-md-4">
                                <label for="input1" class="form-label">Kategorie</label>
                            ...
                            <div class="col-12">
                                <label for="editor1" class="form-label">Beschreibung</label>
                                <textarea name="job_desc" id="editor1" rows="5" class="form-control editor"></textarea>
                            </div>
                            <div class="col-md-4">
                                <label for="input7" class="form-label">Bewerbungsfrist </label>
                                <input type="date" class="form-control" name="end_date" id="input7" value="<?php echo $expire; ?>">
                            </div>
                            <div class="col-md-4">
                                <label for="input10" class="form-label">Job erstellt </label>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control" name="start" id="input15">
                            </div>

                            <div class="col-12">
                                <label for="editor2" class="form-label">Bewerbung </label>
                                <textarea name="application" id="editor2" rows="5" class="form-control editor"></textarea>
                            </div>

                            <div class="col-12">
                                <label for="editor3" class="form-label">Aufgabe </label>
                                <textarea name="aufgabe" id="editor3" rows="5" class="form-control editor"></textarea>
                            </div>

                            <div class="col-12">
                                <label for="editor4" class="form-label">Anforderungen </label>
                                <textarea name="anforderungen" id="editor4" rows="5" class="form-control editor"></textarea>
                            </div>

                            <div class="col-12">
                                <label for="editor5" class="form-label">Benefits</label>
                                <textarea name="benefits" id="editor5" rows="5" class="form-control editor"></textarea>
                            </div>


                            <div class="col-md-4">
                                <label for="input17" class="form-label">Job Ansprechpartner </label>
                                <input type="text" class="form-control" name="contact_person" id="input17">
                            </div>
                            <div class="col-md-4">
                                <label for="input18" class="form-label">Job Telefon</label>
                                <input type="text" class="form-control" name="telephone" id="input18">
                            </div>
                            <div class="col-md-4">
                                <label for="input16" class="form-label">Job E-Mail </label>
                                <input type="text" class="form-control" name="email" id="input16">
                            </div>
                            <div class="col-md-12">

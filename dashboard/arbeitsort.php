...
if (isset($_REQUEST['dlt_id'])) {
    $info = dlt_arbeitsort($conn);
}
if (isset($_REQUEST['duplicate'])) {
    $info = duplicate_arbeitsort($conn);
}
$show = ad_show_arbeitsort($conn);
?>
<!doctype html>
<html lang="en">
    ...
    <div class="container-fluid">
        <div class="row">
            <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
                <div class="position-sticky pt-3">
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="arbeitsort.php">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <h2 class="my-3">Arbeitszeit Added</h2>
                <?php echo $info; ?>
                <div class="table-responsive">
                    <table class="table table-striped table-sm">
                        <thead>
                            <tr>
                                <th scope="col">Arbeitsort ID</th>
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            ...
            <div class="modal-header">
                ...
                <form action="arbeitsort.php" method="get">                
                    <input type="hidden" name="dlt_id" value="0" id="sort_id">
